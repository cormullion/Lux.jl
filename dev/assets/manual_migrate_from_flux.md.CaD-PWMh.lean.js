...
const __pageData = JSON.parse('{"title":"Migrating from Flux to Lux","description":"","frontmatter":{},"headers":[],"relativePath":"manual/migrate_from_flux.md","filePath":"manual/migrate_from_flux.md","lastUpdated":null}');
const _sfc_main = { name: "manual/migrate_from_flux.md" };
...
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("mjx-assistive-mml", {
  unselectable: "on",
  display: "inline",
...
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("g", {
  stroke: "currentColor",
  fill: "currentColor",
  "stroke-width": "0",
  transform: "scale(1,-1)"
...
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("mjx-assistive-mml", {
  unselectable: "on",
  display: "inline",
  style: { "top": "0px", "left": "0px", "clip": "rect(1px, 1px, 1px, 1px)", "-webkit-touch-callout": "none", "-webkit-user-select": "none", "-khtml-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none", "position": "absolute", "padding": "1px 0px 0px 0px", "border": "0px", "display": "block", "width": "auto", "overflow": "hidden" }
}, [
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("g", {
  stroke: "currentColor",
  fill: "currentColor",
  "stroke-width": "0",
  transform: "scale(1,-1)"
...
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("mjx-assistive-mml", {
  unselectable: "on",
  display: "inline",
  style: { "top": "0px", "left": "0px", "clip": "rect(1px, 1px, 1px, 1px)", "-webkit-touch-callout": "none", "-webkit-user-select": "none", "-khtml-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none", "position": "absolute", "padding": "1px 0px 0px 0px", "border": "0px", "display": "block", "width": "auto", "overflow": "hidden" }
}, [
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      createTextVNode("Let's work through a concrete example to demonstrate this. We will implement a very simple layer that computes "),
      ...
      createBaseVNode("mjx-container", _hoisted_12, [
        (openBlock(), createElementBlock("svg", _hoisted_13, _hoisted_15)),
        _hoisted_16
      ]),
      createTextVNode(" is not trainable and "),
      createBaseVNode("mjx-container", _hoisted_17, [
        (openBlock(), createElementBlock("svg", _hoisted_18, _hoisted_20)),
        _hoisted_21
      ]),
      createTextVNode(" is trainable.")
    ]),
    _hoisted_22
  ]);
}
const migrate_from_flux = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  migrate_from_flux as default
};
