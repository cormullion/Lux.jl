import { V as VPTeamPageTitle, a as VPTeamPageSection, b as VPTeamMembers, c as VPTeamPage } from "./chunks/theme.WXmeR8Kf.js";
import { c as createElementBlock, I as createVNode, w as withCtx, m as unref, o as openBlock, a as createTextVNode } from "./chunks/framework.D77Eh1z8.js";
        ...
        createVNode(unref(VPTeamPage), null, {
          default: withCtx(() => [
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Frameworks Extending Lux.jl")
              ]),
              members: withCtx(() => [
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Automatic Differentiation")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Data Manipulation, Data Loading & Datasets")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Neural Network Primitives")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
                  members: nnprimitives
                })
              ]),
              _: 1
            }),
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Parameter Manipulation")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
                  members: param_manipulation
                })
              ]),
              _: 1
            }),
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Testing Utilities")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
            ...
            createVNode(unref(VPTeamPageSection), null, {
              title: withCtx(() => [
                createTextVNode("Training Visualization & Logging")
              ]),
              members: withCtx(() => [
                createVNode(unref(VPTeamMembers), {
                  size: "small",
