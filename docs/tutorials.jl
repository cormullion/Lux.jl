...
BEGINNER_TUTORIALS = joinpath.(
    ["Basics", "PolynomialFitting", "SimpleRNN", "SimpleChains"], ("main.jl",))
INTERMEDIATE_TUTORIALS = joinpath.(["NeuralODE", "BayesianNN", "HyperNet"], ("main.jl",))
ADVANCED_TUTORIALS = joinpath.(
    ["GravitationalWaveForm", "SymbolicRegression"], ("main.jl",))
